      ...
      <main className="">
        ...
        <div className="">
          ...
          <div
            ...
            className="flex bg-white   text-lg my-4 text-gray-400  outline-none cursor-pointer p-2 items-center w-1/3 m-2 ml-auto mr-10 border  shadow-gray-50 shadow-xl rounded-xl">
            <Image className="opacity-50" src={searchIcon} />
