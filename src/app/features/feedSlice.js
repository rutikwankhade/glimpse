...
export const getExploreFeed = createAsyncThunk(
  ...
  async () => {
    ...
    try {
      const res = await axios.get(`https://glimpse-backend.onrender.com/api/post/`);
...
export const getUserFeed = createAsyncThunk(
  ...
  async () => {
    ...
    try {
      const res = await axios.get(`https://glimpse-backend.onrender.com/api/post/feed/userfeed`);
...
export const postBookReview = createAsyncThunk(
  ...
  async ({ title,
    ...
    try {
      const res = await axios.post('https://glimpse-backend.onrender.com/api/post/addpost', body, config);
...
export const getLatestUsers = createAsyncThunk(
  ...
  async () => {
    ...
    try {
      const res = await axios.get(`https://glimpse-backend.onrender.com/api/user/`);
