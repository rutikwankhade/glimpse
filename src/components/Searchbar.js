...
const Searchbar = () => {
    ...
    return (
        <div className="w-full mx-2">
            ...
            <div className="flex p-2 items-center md:w-8/12 mx-auto hover:shadow-sm bg-gray-50 shadow-gray-50 rounded-full">
                <Image className="opacity-30 " src={searchIcon} />
                <input
                    placeholder="  Search book by name or author"
                    className=" w-full ml-2 bg-gray-50 flex text-sm md:text-xl text-gray-600  outline-none cursor-pointer"
